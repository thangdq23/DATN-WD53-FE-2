  ...
  const onFinish = async (values) => {
    try {
      ...
      if (res?.success) {
        ...
        setProfile({ ...profile, ...values, avatar: avatarUrl || profile?.avatar });
      } else {
  ...
  const handleAvatarChange = async (info) => {
    if (info.file) {
      try {
        ...
        message.error('Có lỗi khi tải lên ảnh đại diện');
      } finally {
              ...
              <Row gutter={[24, 24]} style={{ marginTop: '16px' }}>
                <Col xs={24} md={8}>
                  <Card 
                    ...
                    bordered={false}
                    headStyle={{ border: 'none', fontSize: '18px', fontWeight: 600 }}
                  >
              ...
              <Card style={{ marginTop: '16px' }}>
                <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <Text type="secondary">Cập nhật mật khẩu thường xuyên để bảo mật tài khoản</Text>
