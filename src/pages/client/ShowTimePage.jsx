      ...
      <div className="relative z-10 max-w-6xl mx-auto py-14 px-6 md:px-10">
        ...
        >
          ...
          <div>
            ...
            <h3 className="text-xl font-semibold text-red-400 mt-5 mb-2">
              Mô tả
            </h3>
            ...
            <div className="mt-6">
              ...
              {loadingShowtime ? (
                <div className="flex items-center gap-2 text-gray-300">
                  <Spin size="small" /> Đang tải suất chiếu...
                </div>
            ...
            {loadingList ? (
              ...
              otherMovies.map((m) => (
                <Link key={m._id} to={`/showtime/${m._id}`}>
                  <FM.div
                    whileHover={{ scale: 1.05 }}
                    className="relative bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/10"
                  >
                    <img
                      src={m.poster}
                      alt={m.name}
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        setTrailerModal({
                          open: true,
                          url: normalizeYouTubeEmbed(m.trailer),
                          title: m.name,
                        });
                      }}
        ...
        <Modal
          ...
          onCancel={() =>
            setTrailerModal({ open: false, url: null, title: "" })
          }
          footer={null}
