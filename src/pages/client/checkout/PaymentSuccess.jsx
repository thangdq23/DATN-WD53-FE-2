  ...
  const PaymentSuccess =() =>{
    ...
    return(
        <div className="mt-8 py-8">
            ...
            <div ref={ticketRef}>
            <div className="min-h-screen max-w-7xl xl:mx-auto mx-6 grid gap-4" style={{ gridTemplateColumns: "2fr 1fr" }}>
                <div className="mt-8">
                    <Card
                    className="shadow-md!"
                    title={
                    ...
                    >
                        ...
                        <img src={data?.data?.moviePoster} className="h-64 w-48 rounded-lg object-cover" alt=""/>
                        <div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <div
                                style={{backgroundColor: ORDER_STATUS[data?.data?.status]?.bgColor, 
                                ...
                                <div>
                                    ...
                                    <p className={`font-semibold mb-0! flex justify-center px-4 rounded-md`}
                                        style={{
                                            color: ORDER_STATUS[data?.data?.status]?.color,
                                            backgroundColor:
