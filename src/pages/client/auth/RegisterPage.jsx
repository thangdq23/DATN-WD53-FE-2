        ...
        <div className="hidden md:block w-1/2 relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8 text-white z-10">
            ...
            <p className="text-white/80">
              Trải nghiệm đặt vé xem phim tiện lợi và nhận nhiều ưu đãi hấp dẫn.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center">
          <div className="w-full max-w-md">
            <div className="flex justify-center gap-8 mb-8 border-b border-gray-200">
              ...
              <div className="pb-2 font-bold text-xl text-gray-900 border-b-2 border-red-500 cursor-pointer">
                Đăng ký
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Form.Item
                  ...
                  hasFeedback
                  rules={[
                    formRules.required("Mật khẩu"),
                    formRules.passwordStrong("Mật khẩu", { min: 8 }),
                  ]}
                  className="mb-0"
                >
                  <Input.Password
              ...
              <div className="text-center">
                <p className="text-gray-500 text-sm font-medium">
                  ...
                  <Link
                    to={"/auth/login"}
                    className="text-[#D66D75] hover:underline transition-all"
                  >
                    Đăng nhập ngay
                  </Link>
                </p>
