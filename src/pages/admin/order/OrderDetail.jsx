                  ...
                  >
                    ...
                    <div>
                      ...
                      <Text style={{ marginLeft: 8 }}>
                        {seats.length > 0
                          ? seats
                              .map((seat) => seat.label || `Ghế ${seat.seatId}`)
                              .join(", ")
                          : "Chưa có thông tin"}
                      </Text>
                    </div>
            ...
            >
              ...
              >
                <Descriptions.Item label="Họ và tên" span={3}>
                  <Text strong>
                    {order.customerInfo?.userName || "Khách vãng lai"}
                  </Text>
                </Descriptions.Item>
              ...
              <Space direction="vertical" style={{ width: "100%" }}>
                {order?.status === "buyed" && (
                  <Button
                    ...
                    style={{ width: "100%" }}
                    onClick={() => {
                      // Navigate to QR scanning page with code pre-filled
                      navigate(
                        `/admin/ticket/qr?code=${encodeURIComponent(
                          order.ticketId,
                        )}`,
                      );
                    }}
                ...
                <Button
                  ...
                  style={{
                    width: "100%",
                    marginTop:
                      order?.status === "pending" || order?.status === "used"
                        ? 0
                        : "8px",
                  }}
                  ...
                  onClick={async () => {
                    try {
                      ...
                      if (!qrCodeCanvas) {
                        throw new Error(
                          "Không tìm thấy mã QR. Vui lòng thử lại.",
                        );
                      }
