    ...
    return(
        ...
        <div className="mt-4">
          <Form onFinish={handleSubmit} layout="vertical" form={form}>
            ...
            <section className="flex flex-center justìy-between gap-6">
                <Form.Item
                  label="Quốc gia"
                  name={"country"}
                  required
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  >
                    ...
                    suffixIcon={null}
                    placeholder="Nhập tên diễn viên và ấn Enter"
                    style={{width:"100%",height:35}}
                    tokenSeparators ={[","]}
                    open={false}
                    />
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    style={{flex:1}}
                    rules={[
                      {required: true, message:"Vui lòng nhập ngày công chiếu"}
                    ]}
                    >
                      <DatePicker 
                      palceholder="Chọn ngày công chiếu"
                      style={{height: 35, width:"100%"}}
                      disabledDate={(current)=>current && current <dayjs().startOf("day").add(1)}
                      />
                    </Form.Item>
                    ...
                    rules={[
                      {required: true, message:"Vui lòng nhập ngày kết thúc chiếu"},
                      ({getFieldValue})=>({
                        validator(_, value){
                    ...
                    >
                       <DatePicker 
                      palceholder="Chọn ngày kết thúc"
                      style={{height: 35, width:"100%"}}
                      disabledDate={(current)=>current && current <dayjs().startOf("day").add(1)}
                      />
                    </Form.Item>
